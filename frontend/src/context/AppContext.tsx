...
export const user_service = "https://user-service-yi49.onrender.com";
export const author_service ="https://author-service-e8vf.onrender.com";
export const blog_service = "https://blog-service-6hwi.onrender.com";
